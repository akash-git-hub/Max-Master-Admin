...
import { createModuleAPI, createSubModuleAPI, updateModuleAPI } from "../../services/NetworkCall";
...
export const CreateSubModule = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    //   navigate("/sub-module-list", { state: { data: { id: moduleId } } });
    window.history.back();
    } else {
        ...
        <div className="flex-grow-1 py-3">
          ...
          >
            ...
            >
              ...
              />
              <h4 className="fw-bold mb-0 text-start"> Create Sub Module</h4>
            </Stack>
